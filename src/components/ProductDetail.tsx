                ...
                <div className="flex flex-col">
                    ...
                    <div className="space-y-6 mb-10">
                        <button
                            ...
                            className="w-full py-5 bg-[#3d2b1f] text-white rounded-2xl font-black text-lg shadow-xl shadow-orange-900/20 hover:bg-[#5c4033] transition-all hover:-translate-y-1 flex items-center justify-center gap-3 group"
                        >
